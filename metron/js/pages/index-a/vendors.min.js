		...
		Nn =
			...
			(Se = (function() {
				...
				return (
					...
					(t._getConfig = function(t) {
						return (
							'number' == typeof (t = h({}, this.constructor.Default, oe(this.element).data(), 'object' == typeof t && t ? t : {})).delay &&
...
!(function() {
		...
		if ((h.push({ x: t, y: o, lastX: t < 0 ? 0.99 : -0.99, lastY: o < 0 ? 0.99 : -0.99, start: Date.now() }), !p)) {
			var u = e === document.body,
				d = function(n) {
					...
					u ? window.scrollBy(i, l) : (i && (e.scrollLeft += i), l && (e.scrollTop += l)),
						t || o || (h = []),
	...
	function b(t) {
		...
		s &&
			(t.wheelDeltaX && B(t.wheelDeltaX, 120) && (n = (t.wheelDeltaX / Math.abs(t.wheelDeltaX)) * -120),
			t.wheelDeltaY && B(t.wheelDeltaY, 120) && (a = (t.wheelDeltaY / Math.abs(t.wheelDeltaY)) * -120)),
		...
		j = function() {
			if (!K) {
				...
				document.documentElement.scrollTop,
					window.scrollBy(0, 3),
					(K = document.body.scrollTop != t ? document.body : document.documentElement),
					window.scrollBy(0, -3),
	...
	function q(e) {
		var t, o;
		return (
			(e *= r.pulseScale) < 1 ? (t = e - (1 - Math.exp(-e))) : ((e -= 1), (t = (o = Math.exp(-1)) + (1 - Math.exp(-e)) * (1 - o))), t * r.pulseNormalize
		);
	}
	function V(e) {
						...
						? void (h[e] = (function() {
								...
								return function() {
									var e,
										...
										o = this._superApply;
									return (
										(this._super = t), (this._superApply = n), (e = i.apply(this, arguments)), (this._super = s), (this._superApply = o), e
									);
								};
						  })())
						: void (h[e] = i);
		...
		t.widget('aerolab.midnight', {
			...
			refresh: function() {
				(this._headerInfo = { top: 0, height: this.element.outerHeight() }),
					(this._$sections = t('[data-' + this.options.sectionSelector + ']:not(:hidden)')),
					(this._sections = []),
					this._setupHeaders(),
					this.recalculate();
			},
				...
				return (
					e.length
						? e.each(function() {
								...
								o.length
									? (o.css('bottom', 'auto').css('overflow', 'auto'), (i = o.outerHeight()), o.css('bottom', '0'))
									: (e.css('bottom', 'auto'), (i = e.outerHeight()), e.css('bottom', '0')),
									(s = i > s ? i : s);
						  })
				...
				for (var n in this._headers)
					if (this._headers.hasOwnProperty(n) && 'undefined' == typeof this._headers[n].element) {
						...
						this._headers[n].element.css(h),
							...
							this._headers[n].element.find('> .' + this.options.innerClass).length ||
								this._headers[n].element.wrapInner('<div class="' + this.options.innerClass + '"></div>'),
					...
					s >= this._sections[h].start &&
						...
						e >= this._sections[h].start && s <= this._sections[h].end
							...
							? ((this._headers[this._sections[h].className].from = 'top'),
							  (this._headers[this._sections[h].className].progress = 1 - (s - this._sections[h].end) / t))
							: s > this._sections[h].start &&
							  ...
							  ('top' === this._headers[this._sections[h].className].from
									...
									: ((this._headers[this._sections[h].className].from = 'bottom'),
									  (this._headers[this._sections[h].className].progress = (s - this._sections[h].start) / t))));
			},
				...
				if ('undefined' != typeof this._headers[this.options.defaultClass]) {
					...
					t < 1 &&
						('' === this._headers[this.options.defaultClass].from
							? ((this._headers[this.options.defaultClass].from = 'top' === this._headers[e].from ? 'bottom' : 'top'),
							...
							n >= 100 && (n = 110),
								...
								'top' === this._headers[i].from
									? this._transformMode !== !1
										? ((this._headers[i].element[0].style[this._transformMode] = 'translateY(-' + n + '%) translateZ(0)'),
										  (this._headers[i].inner[0].style[this._transformMode] = 'translateY(+' + n + '%) translateZ(0)'))
