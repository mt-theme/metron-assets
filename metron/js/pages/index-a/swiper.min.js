		...
		h =
			((l = e.createElement('div')),
			{
				...
				transforms3d:
					...
					((n = l.style), 'webkitPerspective' in n || 'MozPerspective' in n || 'OPerspective' in n || 'MsPerspective' in n || 'perspective' in n),
				flexbox: (function() {
					for (
						var e = l.style,
	...
	var u = {
		...
		updateSlides: function() {
			...
			if (void 0 !== s) {
				...
				0 === l.length && (l = [0]),
					0 !== e.spaceBetween &&
						(this.isHorizontal() ? (a ? n.css({ marginLeft: b + 'px' }) : n.css({ marginRight: b + 'px' })) : n.css({ marginBottom: b + 'px' })),
	...
	var v = {
		...
		setTranslate: function(e, t) {
			...
			this.isHorizontal() ? (n = i ? -e : e) : (o = e),
				...
				s.virtualTranslate ||
					(h.transforms3d ? a.transform('translate3d(' + n + 'px, ' + o + 'px, 0px)') : a.transform('translate(' + n + 'px, ' + o + 'px)')),
	...
	var w = {
		...
		y = (function() {
			...
			if (
				...
				s.minimalUi =
					!s.webView && (o || l) && (1 * d[0] == 7 ? 1 * d[1] >= 1 : 1 * d[0] > 7) && h && h.getAttribute('content').indexOf('minimal-ui') >= 0;
			}
					...
					if ((o.originalEvent && (o = o.originalEvent), i.isTouched)) {
						if (!i.isTouchEvent || 'mousemove' !== o.type) {
							...
							if (!this.allowTouchMove)
								return (
									(this.allowClick = !1),
									void (i.isTouched && (d.extend(r, { startX: l, startY: h, currentX: l, currentY: h }), (i.touchStartTime = d.now())))
								);
									...
									if (
										...
										v > 0 && i.currentTranslate > this.minTranslate()
											...
											: v < 0 &&
											  ...
											  ((f = !1),
											  a.resistance &&
													(i.currentTranslate = this.maxTranslate() + 1 - Math.pow(this.maxTranslate() - i.startTranslate - v, m))),
					...
					if (
						...
						for (var z = 0, k = t.slidesSizesGrid[0], P = 0; P < o.length; P += s.slidesPerGroup)
							void 0 !== o[P + s.slidesPerGroup]
								? p >= o[P] && p < o[P + s.slidesPerGroup] && ((z = P), (k = o[P + s.slidesPerGroup] - o[P]))
			...
			if (h.touch || (!h.pointerEvents && !h.prefixedPointerEvents)) {
				if (h.touch) {
					...
					o.addEventListener(a.start, this.onTouchStart, p),
						o.addEventListener(a.move, this.onTouchMove, h.passiveListener ? { passive: !1, capture: l } : l),
	...
	var B = {
		...
		Q = {
			setTranslate: function() {
				...
				i.transform(
					'translate3d(0px,0,' + L + 'px) rotateX(' + (this.isHorizontal() ? 0 : c) + 'deg) rotateY(' + (this.isHorizontal() ? -c : 0) + 'deg)'
				);
			},
			setTransition: function(e) {
				var t = this.$el;
				...
				on: {
					...
					click: function(e) {
						...
						!this.params.navigation.hideOnClick ||
							s(e.target).is(a) ||
							s(e.target).is(i) ||
							(i && i.toggleClass(this.params.navigation.hiddenClass), a && a.toggleClass(this.params.navigation.hiddenClass));
					},
				},
			},
			{
